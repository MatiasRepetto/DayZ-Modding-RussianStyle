class LongLifeRechargeableBattery9V_1 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "9V Long Life Rechargeable Battery";
		...
		InsertIngredient(1, "RechargeableBattery9V");
		...
		//result1
		AddResult("LongLifeRechargeableBattery9V");//add results here
